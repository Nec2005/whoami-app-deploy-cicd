    ...
    Statement = [
      {
        ...
        Condition = {
          StringEquals = {
            ...
            "${data.terraform_remote_state.eks.outputs.aws_iam_openid_connect_provider_extract_from_arn}:sub": "system:serviceaccount:default:external-dns" # service account name and namespace
          }
        }        
      },
    ]
